...
def show_unemployment_rate():
    st.header("1978 - 2025 Unemployment Rate of All States in Australia")
    ...
    plot_unemployment_graph(df2, "Unemployment Rate in Australia (1978 - 2025)", "Unemployment Rate (%)", key='unemployment_rate_line')

    # Bar Graph
    st.subheader("Bar Graph")
    plot_unemployment_bar_graph(
        df2,
        title="Unemployment Rate in Australian States (1978 - 2025)",
    ...
    plot_choropleth_map(df2, geojson_path, "Unemployment Rate (1978-2025)")
