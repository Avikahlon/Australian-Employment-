...
def show_unemployment_numbers():
    st.header("1978 - 2024 Total Number of Unemployed People in All States of Australia")
    ...
    plot_unemployment_graph(df1, "Total Number of Unemployed People in Australia (1978 - 2024)", "Unemployment Number (thousand)", key='total_unemployed_line')

    # Bar Graph
    st.subheader("Bar Graph")
    plot_unemployment_bar_graph(
        df1,
        title="Total Number of Unemployed People in Australian States (1978 - 2024)",
    ...
    df1, _ = load_data_map()
    plot_choropleth_map(df1, geojson_path, "Total Number of Unemployed People (1978-2024)")
